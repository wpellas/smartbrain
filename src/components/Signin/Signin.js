...
class Signin extends React.Component {
    ...
    onSubmitSignIn = () => {
        fetch('https://smartbrain-api-pi.vercel.app/signin', {
            method: 'post',
    ...
    render() {
       ...
       return (
        <article className="br3 ba white b--white-10 mv4 w-100 w-50-m w-25-l mw6 shadow-5 center signin">
            <main className="pa4 white-80">
                <div className="measure">
                    ...
                    <div className="lh-copy mt3">
                        <p onClick={() => onRouteChange('register')} className="f6 link dim white db pointer">Register new account</p>
                    </div>
                </div>
        </main>
        </article>
